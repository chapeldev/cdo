...
module Cdo{
    ...
    */
    ...
    class QueryBuilderBase{
        ...
        var _where_cond:list(whereType);
        ...
        var _optype:list(string);

        var _statements:list(StatementData);
        ...
        proc Select(){
            ...
            if(this._statements.contains("select")){
        ...
        proc From(table){
            if(this._statements.contains("from")){
        ...
        proc Where(column:string, op:string, value, concat_op="AND"){
            ...
            if(this._statements.contains("where")){
        ...
        proc Join(table:string, column1:string, op:string, column2:string, join_type:string="INNER" ,concat_op="AND"){
            ...
            if(this._statements.contains("join")){
        ...
        proc Delete(){
            ...
            if(this._statements.contains("delete")){
        ...
        proc OrderBy(column){
            if(this._statements.contains("orderByAsc")){
        ...
        proc OrderByDesc(column){
            if(this._statements.contains("orderByDesc")){
        ...
        proc GroupBy(column){
            if(this._statements.contains("groupBy")){
        ...
        proc Limit(i:int){
            if(this._statements.contains("limit")){
        ...
        proc Offset(i:int){
            if(this._statements.contains("offset")){
        ...
        proc _has(opname:string):bool{
            return this._statements.contains(opname);
        }
