...
proc statementSubstitutionPlaceholderNoOrder(test: borrowed Test) throws {
  ...
  test.assertFalse(st3555._isPlaceholderRemaining());
  test.assertTrue(st3555.getSubstitutedStatement() == "SELECT * FROM CONTACTS WHERE id = 1 AND name = 'testuser' AND has_legs = true;");
}
